              ...
              <div class="col-md-4">
                <div class="card shadow-sm h-100">
                  <div class="card-body text-center">
                    ...
                    <a href="#" id="btn-list-congress" class="btn btn-secondary"
                      >Gestionar</a
                    >
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="card shadow-sm h-100">
                  <div class="card-body text-center">
                    ...
                    <a href="#" id="btn-list-rooms" class="btn btn-secondary"
                      >Gestionar</a
                    >
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="card shadow-sm h-100">
                  <div class="card-body text-center">
                    ...
                    <a
                      href="reporte-participantes.jsp"
                      class="btn btn-secondary"
                      >Generar</a
                    >
                  </div>
              ...
              <div class="col-md-4">
                <div class="card shadow-sm h-100">
                  <div class="card-body text-center">
                    ...
                    <a
                      href="reporte-reserva-taller.jsp"
                      class="btn btn-secondary"
                      >Generar</a
                    >
                  </div>
              ...
              <div class="col-md-4">
                <div class="card shadow-sm h-100">
                  <div class="card-body text-center">
                    ...
                    <p>
                      Ver ganancias obtenidas de inscripciones y actividades.
                    </p>
